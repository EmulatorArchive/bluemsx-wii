...
void GuiKeyboard::Show(void)
{
    ...
    keymap1 = keyboardGetMapping(KEY_JOY1_COMMON_A);
    keymap2 = keyboardGetMapping(KEY_JOY2_COMMON_A);
    keymap3 = keyboardGetMapping(KEY_JOY1_WIIMOTE_A);
    keymap4 = keyboardGetMapping(KEY_JOY2_WIIMOTE_A);
    keyboardRemapKey(KEY_JOY1_COMMON_A, EC_NONE);
    keyboardRemapKey(KEY_JOY2_COMMON_A, EC_NONE);
...
void GuiKeyboard::Remove(void)
{
    ...
    keyboardRemapKey(KEY_JOY1_COMMON_A, keymap1);
    keyboardRemapKey(KEY_JOY2_COMMON_A, keymap2);
    keyboardRemapKey(KEY_JOY1_WIIMOTE_A, keymap3);
    keyboardRemapKey(KEY_JOY2_WIIMOTE_A, keymap4);
}
