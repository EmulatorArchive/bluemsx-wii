...
{
    root->ReleaseAtom(g_imgButtonRed);
    g_imgButtonRed = NULL;
    root->ReleaseAtom(g_imgButtonGreen);
    g_imgButtonGreen = NULL;
    root->ReleaseAtom(g_imgButtonBlue);
    g_imgButtonBlue = NULL;
    root->ReleaseAtom(g_imgButtonYellow);
    g_imgButtonYellow = NULL;
    root->ReleaseAtom(g_imgKeyboard);
    g_imgKeyboard = NULL;
    root->ReleaseAtom(g_imgKeyboard2);
    g_imgKeyboard2 = NULL;
    root->ReleaseAtom(g_imgFloppyDisk);
    g_imgFloppyDisk = NULL;
    root->ReleaseAtom(g_imgSelector);
    g_imgSelector = NULL;
    root->ReleaseAtom(g_imgSelector2);
    g_imgSelector2 = NULL;
    root->ReleaseAtom(g_imgNoise);
    g_imgNoise = NULL;
    root->ReleaseAtom(g_imgMousecursor);
    g_imgMousecursor = NULL;
    root->ReleaseAtom(g_imgBackground);
    g_imgBackground = NULL;
    root->ReleaseAtom(g_imgArrow);
    g_imgArrow = NULL;
    root->ReleaseAtom(g_imgCheckboxChecked);
    g_imgCheckboxChecked = NULL;
    root->ReleaseAtom(g_imgCheckbox);
    g_imgCheckbox = NULL;
    root->ReleaseAtom(g_imgUp);
    g_imgUp = NULL;
    root->ReleaseAtom(g_imgDown);
    g_imgDown = NULL;
    root->ReleaseAtom(g_imgAdd);
    g_imgAdd = NULL;
    root->ReleaseAtom(g_imgDelete);
    g_imgDelete = NULL;
    root->ReleaseAtom(g_imgDelete2);
    g_imgDelete2 = NULL;
    root->ReleaseAtom(g_imgSettings);
    g_imgSettings = NULL;
    root->ReleaseAtom(g_imgFrameA);
    g_imgFrameA = NULL;
    root->ReleaseAtom(g_imgFrameB);
    g_imgFrameB = NULL;
    root->ReleaseAtom(g_imgFrameC);
    g_imgFrameC = NULL;
    root->ReleaseAtom(g_imgInputBar);
    g_imgInputBar = NULL;
}
