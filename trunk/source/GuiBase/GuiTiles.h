...
#ifndef GUIBASE_TILES
#define GUIBASE_TILES
...
class GuiTiles : public GuiLayer {
public:
    //!Constructor.
    ...
    void SetStaticTileset(GuiImage* image, u32 tileWidth, u32 tileHeight);
...
private:
    ...
    GuiImage* _image; u32 _tiles;
};

/*! \page tiledlayer_animations_page GuiTiles - Animations
 * Animations can help you bring that little movement in a normally static layer.
 *
 * You probably already understand how to set cells on a GuiTiles and how to draw them. GuiTiles
 ...
 * you initialize GuiTiles, you specify how many of these animation tiles you want to possibly have.
 *
 * If you want to get a new index for an animated tile, call CreateAnimatedTile() and the GuiTiles
 * will return a new nuber to use. The first animated tile is -1, the second is -2, the third -3 and so
 * on. You can SetCell() or FillCell() the GuiTiles with this index.
 *
