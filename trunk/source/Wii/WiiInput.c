...
static void initKbdTable()
{
    ...
    kbdTable[KEY_JOY1_BUTTON_1] = EC_JOY1_BUTTON2;
    kbdTable[KEY_JOY1_BUTTON_2] = EC_JOY1_BUTTON1;
    ...
    kbdTable[KEY_JOY2_BUTTON_1] = EC_JOY2_BUTTON2;
    kbdTable[KEY_JOY2_BUTTON_2] = EC_JOY2_BUTTON1;
