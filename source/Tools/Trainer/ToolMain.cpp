...
extern "C" int Trainer_Create(Interface* toolInterface, char* name, int length)
{
...
extern "C" void Trainer_Destroy()
{
    OnDestroyTool();
}

extern "C" void Trainer_Show()
{
    OnShowTool();
}

extern "C" void Trainer_NotifyEmulatorStart()
{
    OnEmulatorStart();
}

extern "C" void Trainer_NotifyEmulatorStop()
{
    OnEmulatorStop();
}

extern "C" void Trainer_NotifyEmulatorPause()
{
    OnEmulatorPause();
}

extern "C" void Trainer_NotifyEmulatorResume()
{
    OnEmulatorResume();
}

extern "C" void Trainer_NotifyEmulatorReset()
{
    OnEmulatorReset();
}

extern "C" void Trainer_EmulatorTrace(const char* message)
{
    OnEmulatorTrace(message);
}

extern "C" void Trainer_EmulatorSetBreakpoint(UInt16 slot, UInt16 page, UInt16 address)
{
    if (page == 0xffff) {
        if (slot == 0xffff) {
...
extern "C" void Trainer_SetLanguage(int languageId)
{
    OnSetLanguage((LanguageId)languageId);
}

extern "C" void Trainer_AddArgument(const char* str, void* arg)
{
    OnAddArgument(str, arg);
}

extern "C" const char* Trainer_GetName()
{
    return OnGetName();
}
