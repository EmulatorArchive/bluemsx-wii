...
void GuiDialog::AddIndex(int index, Layer *layer, bool fix, GuiEffect *effect)
{
...
void GuiDialog::AddTop(Layer *layer, GuiEffect *effect)
{
...
void GuiDialog::AddTopFixed(Layer *layer, GuiEffect *effect)
{
...
bool GuiDialog::AddOnTopOf(Layer *ontopof, Layer *layer, GuiEffect *effect)
{
    return GuiContainer::AddOnTopOf(ontopof, layer, effect);
}
bool GuiDialog::AddOnTopOf(Layer *ontopof, GuiElement *element, GuiEffect *effect)
{
...
bool GuiDialog::AddBehind(Layer *behind, Layer *layer, GuiEffect *effect)
{
    return GuiContainer::AddBehind(behind, layer, effect);
}
bool GuiDialog::AddBehind(Layer *behind, GuiElement *element, GuiEffect *effect)
{
...
void GuiDialog::AddBottom(Layer *layer, GuiEffect *effect)
{
...
#ifdef DEBUG
void GuiDialog::_Remove(const char *file, int line, Layer *layer, GuiEffect *effect)
{
...
void GuiDialog::_RemoveAndDelete(const char *file, int line, Layer *layer, GuiEffect *effect)
{
...
#else
void GuiDialog::Remove(Layer *layer, GuiEffect *effect)
{
...
void GuiDialog::RemoveAndDelete(Layer *layer, GuiEffect *effect)
{
...
GuiElement* GuiDialog::CheckCollision(Sprite *sprite)
{
    GRITEM *item = first_item;
    while( item != NULL ) {
